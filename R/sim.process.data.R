...
#' 
#' For a more complete description and documentation, see process.data in RMark.
#' 
...
#' @param model Type of analysis model. See help for function mark in RMark for a list of
